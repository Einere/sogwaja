        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="space-y-4">
            ...
            {/* <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-[#FEE500] rounded-lg px-4 py-3 text-gray-900 font-medium hover:bg-[#FDD835] disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-[#03C75A] rounded-lg px-4 py-3 text-white font-medium hover:bg-[#02B350] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
