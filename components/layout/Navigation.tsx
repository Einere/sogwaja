      ...
      <ul className="flex h-16 items-center justify-around">
        <li className="flex-1">
          <Link
            ...
            className={cn(
              "focus:ring-ring flex h-full flex-col items-center justify-center rounded transition-colors focus:ring-2 focus:outline-none",
          ...
          >
            <PencilIcon className="mb-1 h-6 w-6" aria-hidden="true" />
        ...
        <li className="flex-1">
          ...
          >
            <ClipboardIcon className="mb-1 h-6 w-6" aria-hidden="true" />
